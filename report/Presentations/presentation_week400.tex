...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{manbase.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{motor_speeds.eps}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{pd_block_diagram.png}
...
\begin{figure}
    \centering
    \includegraphics[width=\textwidth]{angle_towards_line.eps}
